...
import { VisitingCardAccessDialogComponent } from '../visiting-card-access-dialog/visiting-card-access-dialog.component';
...
@Component({
  selector: 'app-visiting-card-access-list',
  templateUrl: './visiting-card-access-list.component.html',
  styleUrls: ['./visiting-card-access-list.component.css']
})
export class VisitingCardAccessListComponent implements OnInit {

  displayedColumns: string[] = ['id','employeeCode','employeeName','grade','branchName', 'departmentName', 'visitingCardStatus', 'Action'];
  ...
  constructor( private service1: DashboardService,private storageEncryptionService:StorageEncryptionService,private formBuilder: FormBuilder, private service:VisitingCardAccessService, private alertify: AlertifyService, public dialog: MatDialog) { }
  ...
  openDialog() {
    this.dialog.open(VisitingCardAccessDialogComponent, {
      width: '100%',
      disableClose:true
