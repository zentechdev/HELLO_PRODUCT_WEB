...
export class BranchListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['branchId', 'stateName', 'cityName', 'branchName', 'branchCode', 'colorDisplay', 'isActive', 'Action'];
  ...
  constructor(private formBuilder:FormBuilder,private storageEncryptionService: StorageEncryptionService, private service: BranchService, private alertify: AlertifyService, public dialog: MatDialog) { }
  ...
  deleteData(branchId: number) {
    this.alertify.confirm('Delete branch', 'Are you sure to delete branch',
      () => {
