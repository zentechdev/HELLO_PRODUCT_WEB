...
@Component({
  selector: 'app-brochure-share-report',
  templateUrl: './brochure-share-report.component.html',
  styleUrls: ['./brochure-share-report.component.css']
})
export class BrochureShareReportComponent implements OnInit {
  ...
  dateEvent() {
    ...
    this.service.getAllSharedBrochureByDateRange(queryParams)
      .subscribe({
        next: (res) => {
          this.data=res;
          this.dataSource = new MatTableDataSource(res);
